...
#Labels
Label(win, text = "Welcome to the Bharat Bank Portal", font=('calibri',14)).grid(row=0,sticky=N,pady=10)
Label(win, text = "The Most Trusted Bank ever", font=('calibri',10)).grid(row=1,sticky=N)
...
Button(win, text="Login", font=('calibri',12),width=20,command=login).grid(row=4,sticky=N,pady=10)
